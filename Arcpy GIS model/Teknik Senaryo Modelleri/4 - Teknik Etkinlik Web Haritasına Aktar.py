...
# Define output paths
etkin_olan = Workspace + "\\Teknik_Etkin_Olan_WGS84"
etkin_olmayan = Workspace + "\\Teknik_Etkin_Olmayan_WGS84"
etkinlayer = Workspace + "\\etkinlyr"
etkinolmayanlayer = Workspace + "\\etkinolmayanlyr"
etkin_kmz = Teknik_Etkinlik_Klasor + "\\etkin_olan.kmz"
etkin_olmayan_kmz = Teknik_Etkinlik_Klasor + "\\etkin_olmayan.kmz"
etkinlayer1 = Teknik_Etkinlik_Klasor + "\\etkin_olan.lyr"
etkinolmayanlayer2 = Teknik_Etkinlik_Klasor + "\\etkin_olmayan.lyr"
...
arcpy.FeatureClassToFeatureClass_conversion(Teknik_Etkinlik_Klasor + "\\etkin_olan.lyr\\etkin_olan.lyr.gdb\\Polylines" , Workspace, "etkin_olan")
arcpy.FeatureClassToFeatureClass_conversion(Teknik_Etkinlik_Klasor + "\\etkin_olmayan.lyr\\etkin_olmayan.lyr.gdb\\Polylines" , Workspace, "etkin_olmayan")
