...
# Define output paths
etkin_olan = Workspace + "\\Sosyal_Etkin_Olan_WGS84"
etkin_olmayan = Workspace + "\\Sosyal_Etkin_Olmayan_WGS84"
etkinlayer = Workspace + "\\etkinlyr"
etkinolmayanlayer = Workspace + "\\etkinolmayanlyr"
etkin_kmz = Sosyal_Etkinlik_Klasor + "\\etkin_olan.kmz"
etkin_olmayan_kmz = Sosyal_Etkinlik_Klasor + "\\etkin_olmayan.kmz"
etkinlayer1 = Sosyal_Etkinlik_Klasor + "\\etkin_olan.lyr"
etkinolmayanlayer2 = Sosyal_Etkinlik_Klasor + "\\etkin_olmayan.lyr"
...
arcpy.FeatureClassToFeatureClass_conversion(Sosyal_Etkinlik_Klasor + "\\etkin_olan.lyr\\etkin_olan.lyr.gdb\\Polylines" , Workspace, "etkin_olan")
arcpy.FeatureClassToFeatureClass_conversion(Sosyal_Etkinlik_Klasor + "\\etkin_olmayan.lyr\\etkin_olmayan.lyr.gdb\\Polylines" , Workspace, "etkin_olmayan")
